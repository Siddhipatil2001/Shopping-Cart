...
import com.casestudy.practise.orders.repository.AddressRepository;
import com.casestudy.practise.orders.repository.OrderRepository;
...
//	RestTemplate restTemplate;
	...
	@Override
	public void placeOrder(Cart cart,String mode,String email) {
		...
		order.setFullName(orderRepository.findByEmail(email));
